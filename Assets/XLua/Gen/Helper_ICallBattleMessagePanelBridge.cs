...
{
    public class HelperICallBattleMessagePanelBridge : LuaBase, Helper.ICallBattleMessagePanel
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new HelperICallBattleMessagePanelBridge(reference, luaenv);
		}
		
		public HelperICallBattleMessagePanelBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		void Helper.ICallBattleMessagePanel.InitBattleMessage(int camp, int heroId, string id)
		{
		...
		void Helper.ICallBattleMessagePanel.FlushData(int camp, string id)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
